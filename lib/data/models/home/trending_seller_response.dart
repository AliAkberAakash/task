...
List<TrendingSellerResponse> trendingSellerResponseFromJson(String str) => json.decode(str).map((x) => List<TrendingSellerResponse>.from(x.map((x) => TrendingSellerResponse.fromJson(x))));
